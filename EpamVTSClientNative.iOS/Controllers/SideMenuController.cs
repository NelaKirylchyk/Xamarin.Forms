...
{
    public partial class SideMenuController : BaseViewController<MenuViewModel>
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            introButton.SetTitle("LIST", UIControlState.Normal);
            ...
            contentButton.SetTitle("VACATION", UIControlState.Normal);
